...
class AppLocalizationsHi extends AppLocalizations {
  ...
  @override
  String get profilePhotoTitle => 'प्रोफ़ाइल फ़ोटो';

  @override
  String get profilePhotoRealTab => 'असली फ़ोटो';

  @override
  String get profilePhotoAvatarTab => 'अवतार';

  @override
  String get profilePhotoCamera => 'कैमरा';

  @override
  String get profilePhotoGallery => 'गैलरी';

  @override
  String get profilePhotoHint => 'फ़ोटो चुनें या नीचे से अवतार चुनें';

  @override
  String get profilePhotoPrompt =>
      'अब आइए आपकी प्रोफ़ाइल को व्यक्तिगत बनाएं! 📸 आप असली फ़ोटो अपलोड कर सकते हैं या हमारे मज़ेदार अवतारों में से एक चुन सकते हैं:';

  @override
  String get profilePhotoConfirmation =>
      'बहुत बढ़िया चुनाव! आपकी प्रोफ़ाइल बहुत अच्छी लग रही है! 😊';

  @override
  String get profilePhotoTip =>
      '💡 **सुझाव:** आप \'मेरी फ़ोटो बदलो\' या \'मेरा अवतार बदलो\' कहकर किसी भी समय फ़ोटो बदल सकते हैं।';

  @override
  String get profilePhotoChangeRequest =>
      'ज़रूर! आइए मैं आपको प्रोफ़ाइल फ़ोटो अपडेट करने के विकल्प दिखाता हूं:';
